...
function init(input_str) {
    Chain.store('init', Chain.thisAddress);
...
function main(input_str) {
    ...
    if (a[0] === '1') {
        ...
        Chain.store('main', JSON.stringify(Chain.contractQuery(a[1], result)));
    }
    return '';
}
...
function query(input_str) {
    ...
    if (a[0] === '2') {
        ...
        return Chain.contractQuery(a[2], result_1).result;
    }
    ...
    if (a[0] === '3') {
        ...
        return Chain.contractQuery(a[3], result_3).result;
    }
    ...
    if (a[0] === '4') {
        ...
        return Chain.contractQuery(a[4], result_4).result;
