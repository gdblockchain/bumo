...
function init(input_str) {
    //first,buQikZu3TddDRBu2dKTqYCH7Nttzae8H2bfN,buQpfuDN9YcW8wtijN15wABenBHYUoQmHMNq,buQZrn7YLLiKpJ5D4iHsHa6Roigp619hKmoC

    //let str = '1016-09-19';
    //let result = str.replace('1', '2');

    //Chain.store('init', result);
...
function main(input_str) {
    ...
    if (a[0] === '2') {
        ...
        Chain.delegateCall(a[1], result_2);
    }
    ...
    if (a[0] === '3') {
        ...
        Chain.delegateCall(a[1], result_3);
