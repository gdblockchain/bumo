...
function drawBu (drawBuAmount){
    assert(drawBuAmount !== undefined, "destAmount is nil");
    ...
    msg.drawBuAmount = drawBuAmount;
    msg.blockTimestamp = blockTimestamp;
    storageStore("drawBu", JSON.stringify(msg));
    payCoin(sender, drawBuAmount);
    return true;
}
...
function main (input_str){
    ...
    }else if  (input.method === "drawBu"){
        drawBu(input.params.drawBuAmount);
