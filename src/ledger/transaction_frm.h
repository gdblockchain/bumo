...
namespace bumo {
	...
	public:
		...
		bool DauReward(int64_t actual_fee, int64_t& total_fee, AccountFrm::pointer& source_account);
		bool AllocateFeesByShare(const std::string& address, int64_t actual_fee, int64_t& total_fee, uint32_t share);
